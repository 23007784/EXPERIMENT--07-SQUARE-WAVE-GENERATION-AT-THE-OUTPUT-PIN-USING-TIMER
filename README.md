...
## Output screen shots of proteus  :
 ![exp7pmc](https://github.com/user-attachments/assets/8df9a244-c2cb-4718-92eb-9e4215106917)

## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![exp7pmc2](https://github.com/user-attachments/assets/386ca0df-303b-4fcc-b292-1a412ba0bed7)

## DUTY CYCLE AND FREQUENCY CALCULATION 
FOR PULSE AT 500
![500](https://github.com/user-attachments/assets/5a30b582-9648-45bb-b72f-e8971da239e7)
```
TON = 3 x 10 x 10^-6
    = 0.00003
TOFF=0.00003
...
```
FOR PULSE AT 700
![700](https://github.com/user-attachments/assets/7c7bfa77-79eb-4fb2-b327-258d0b648d19)
```
TON = 4 x 10 x 10^-6
    = 0.00004
TOFF= 2 x 10 x 10^-6
...
```
FOR PULSE AT 900
![900](https://github.com/user-attachments/assets/fb62962f-ed9c-4ef5-99bf-89dd4db403c0)
```
TON = 1 x 50 x 10^-6
    = 0.00005
